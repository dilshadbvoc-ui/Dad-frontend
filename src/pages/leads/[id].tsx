                ...
                <div className="md:col-span-1 space-y-6">
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            {lead.phone && <div className="flex items-center gap-3"><Phone className="h-4 w-4 text-muted-foreground" /> <a href={`tel:${lead.phone}`} className="hover:underline">{lead.phone}</a></div>}
