    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent">Contacts</h1>
                    <p className="text-indigo-300/70 mt-1">Manage your contacts and people.</p>
                </div>
            ...
            {isLoading ? (
                <div className="flex items-center justify-center p-12">
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="text-sm text-indigo-300/70">Loading contacts...</p>
                    </div>
                </div>
            ) : (
