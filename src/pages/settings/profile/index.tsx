...
import { getProfile, updateProfile, changePassword, type ProfileUpdateData } from "@/services/settingsService"
...
export default function ProfileSettingsPage() {
    ...
    const handleProfileSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        if (!profile) return
        updateMutation.mutate({ firstName: profile.firstName, lastName: profile.lastName, phone: profile.phone })
    }
