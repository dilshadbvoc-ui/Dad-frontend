        ...
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height={280} minWidth={1} minHeight={1}>
            <BarChart data={data} margin={{ top: 20, right: 16, left: -20, bottom: 0 }}>
              ...
              <XAxis dataKey="name" tick={{ fontFamily: "Poppins, sans-serif", fontSize: 12, fill: "hsl(var(--muted-foreground))" }} tickLine={false} axisLine={false} />
              ...
              <Bar dataKey="totalLeads" name="Total Leads" fill="hsl(var(--chart-4))" radius={[4, 4, 0, 0]}>
                <LabelList dataKey="totalLeads" position="top" fontSize={11} style={{ fontFamily: "Poppins, sans-serif" }} fill="hsl(var(--foreground))" />
              </Bar>
              <Bar dataKey="convertedLeads" name="Converted" fill="hsl(var(--chart-1))" radius={[4, 4, 0, 0]}>
                <LabelList dataKey="convertedLeads" position="top" fontSize={11} style={{ fontFamily: "Poppins, sans-serif" }} fill="hsl(var(--foreground))" />
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        )}
